"""
Django settings for auth_mail project.
...
SECRET_KEY = '-ehm_w)bv$&kv5n$rlb)3a#f!sg3jz_nf6a_lh1r5awla7m50t'
...
WSGI_APPLICATION = 'auth_mail.wsgi.application'
...
STATICFILES_DIRS = (
    ...
    ('auth_imap', os.path.join(BASE_DIR, 'auth_imap', 'static')),
)
...
AUTHENTICATION_BACKENDS = (
    ...
    'auth_imap.backends.ImapAuthenBackend',
    )

LOGIN_URL = '/auth/login/'
LOGOUT_URL = '/auth/logout/'

CONFIGDIR = os.path.join(BASE_DIR, 'config')
